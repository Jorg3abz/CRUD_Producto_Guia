@extends('dashboard') @section('title', 'Editar Categoría')

@section('contenido') <div class="block w-full max-w-xl mx-auto py-12 px-4 sm:px-6">
    
    <div class="mb-8">
        <h2 class="text-3xl font-bold tracking-tight text-white">Editar Categoría</h2>
        <p class="text-sm text-slate-400 mt-2">Modifica el nombre de la categoría seleccionada para actualizar el sistema.</p>
    </div>
