...
<div class="block w-full max-w-xl mx-auto py-12 px-4 sm:px-6">
    ...
    <div class="mb-8">
        <h2 class="text-3xl font-bold tracking-tight text-gray-900">Crear Categoría</h2>
        <p class="text-sm text-gray-500 mt-2">Añade una nueva categoría para organizar tus productos en el inventario.</p>
    </div>
